...
//
// If your AuthURL contains the string "v2" then v2 auth will be used.
// In that case you can also set Region in the Connection structure
//
...
type Connection struct {
	...
	Region         string        // V2 auth: Region to use eg "LON", "ORD" - default is use first region
	// These are filled in after Authenticate is called as are the defaults for above
	storageUrl  string
	authToken   string
	tr          *http.Transport
	client      *http.Client
	AuthHeaders http.Header // V1 auth: the authentication headers so extensions can access them
	V2          bool        // V2 auth: set if V2 auth in use (if AuthURL contains "v2")
	V2Auth      *V2Auth     // V2 auth: the result of the auth
}
